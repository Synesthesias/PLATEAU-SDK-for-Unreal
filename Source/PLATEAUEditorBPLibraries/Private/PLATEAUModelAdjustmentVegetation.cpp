 ...
 * @return 植生か？
 */
bool UPLATEAUModelAdjustmentVegetation::IsVegetationPackage(const int64 InPackage) {
    return static_cast<plateau::dataset::PredefinedCityModelPackage>(InPackage) == plateau::dataset::PredefinedCityModelPackage::Vegetation;
}
