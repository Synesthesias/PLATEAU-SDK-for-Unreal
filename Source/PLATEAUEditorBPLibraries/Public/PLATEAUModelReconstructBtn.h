...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "PLATEAU|BPLibraries|ReconstructPanel")
    static void ReconstructModel(APLATEAUInstancedCityModel* TargetCityModel, TArray<UPLATEAUCityObjectGroup*> TargetCityObjects, const uint8 ReconstructType, bool bDivideGrid, bool bDestroyOriginal);
};
