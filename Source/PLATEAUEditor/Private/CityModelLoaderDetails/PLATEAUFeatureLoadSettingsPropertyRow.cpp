...
void FPLATEAUFeatureLoadSettingsPropertyRow::AddToCategory(IDetailCategoryBuilder& Category, TSharedPtr<IPropertyHandle> FeaturePlacementSettingsProperty) {
    ...
    //    + SVerticalBox::Slot()
    //    [SNew(SComboButton)
    //    .OnGetMenuContent_Raw(this, &FPLATEAUCityModelLoaderDetails::OnGetFeaturePlacementModeComboContent)
    //    .ContentPadding(0.0f)
...
//
//FText FPLATEAUCityModelLoaderDetails::GetComboButtonText() const {
//    uint8 out;
//    FeaturePlacementModeProperty->GetValue(out);
