...
bool SPLATEAUMainTab::IsCurrentIndex(int Id)
{
...
void SPLATEAUMainTab::OnButtonClicked(int Id)
{
    switch (Id)
    {
    case 1:
        UE_LOG(LogTemp, Log, TEXT("MouseButtonDown on 1"));
        SelectingID = 1;
        break;
    case 2:
        UE_LOG(LogTemp, Log, TEXT("MouseButtonDown on 2"));
        SelectingID = 2;
        break;
    case 3:
        UE_LOG(LogTemp, Log, TEXT("MouseButtonDown on 3"));
        SelectingID = 3;
        break;
    default:
        break;
...
const FSlateColor SPLATEAUMainTab::GetTabSelectBGColor(int Id)
{
    switch (Id)
    {
    case 1:
        return SelectingID == 1 ? FSlateColor(COLOR_TABSELECT_BG) : FSlateColor(FColor(0, 0, 0, 0));
        break;
    case 2:
        return SelectingID == 2 ? FSlateColor(COLOR_TABSELECT_BG) : FSlateColor(FColor(0, 0, 0, 0));
        break;
    case 3:
        return SelectingID == 3 ? FSlateColor(COLOR_TABSELECT_BG) : FSlateColor(FColor(0, 0, 0, 0));
        break;
    default:
        return SelectingID == 1 ? FSlateColor(COLOR_TABSELECT_BG) : FSlateColor(FColor(0, 0, 0, 0));
        break;
