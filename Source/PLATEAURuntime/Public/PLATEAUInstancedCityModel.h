...
public:
     ...
     * @param 
     */
    UE::Tasks::FTask ReconstructModel(const TArray<USceneComponent*> TargetComponents, const EPLATEAUMeshGranularity ReconstructType, bool bDivideGrid, bool bDestroyOriginal);
