    ...
    const float azimuth) const
{
    ...
    */
    const glm::vec3 light_xyz = glm::euclidean(glm::vec2(
        glm::radians(altitude), glm::radians(-azimuth)));
    const glm::vec3 light = glm::vec3(light_xyz.x, light_xyz.z, light_xyz.y);
