...
public:
    ...
    TArray<USceneComponent*> Align(const TArray<HeightmapCreationResult> Results, TArray<UPLATEAUCityObjectGroup*> TargetCityObjects, FPLATEAULandscapeParam Param);
